...
fn main() {
    ...
    for _ in 0..t {
        ...
        let n: i32 = tokens.next().expect("Please enter a number").parse().expect("Please enter a valid number");
        let m: i32 = tokens.next().expect("Please enter a number").parse().expect("Please enter a valid number");
