...
fn sort(ii: &mut [usize], l: usize, r: usize, aa: &[usize]) {
    let mut l = l;
    let mut r = r;
...
fn search(a: usize, i: usize, aa: &[usize], ii: &mut [usize], n: usize) -> i32 {
    let mut lower = -1;
...
fn main() {
    ...
    for _ in 0..t {
        ...
        for _ in 0..q {
            ...
            let result = if aa[l] == aa[r] || ii[search(aa[r], l, &aa, &mut ii, n) as usize + 1] < ii[search(aa[l], r, &aa, &mut ii, n) as usize] {
                "YES"
            } else {
                "NO"
            };
