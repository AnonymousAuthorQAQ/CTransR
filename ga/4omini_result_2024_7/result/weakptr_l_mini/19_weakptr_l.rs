...
fn main() {
    ...
    // Resetting ptr1, which will cause MyStruct to be dropped if no other references exist
    drop(ptr1);
    observe(&weak_ptr1); // This will check the weak pointer after the object is dropped
}